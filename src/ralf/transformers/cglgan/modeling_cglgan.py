...
from ralf.transformers.internal.models.cgl import (
    CGLDiscriminator,
    CGLGenerator,
...
from .configuration_cglgan import RalfCGLGANConfig
...
class RalfCGLGANPreTrainedModel(RalfPreTrainedModel):
    config_class = RalfCGLGANConfig
    base_model_prefix = "model"
    tokenizer_class = RalfTokenizer


class RalfCGLGANGeneratorModel(RalfCGLGANPreTrainedModel):
    def __init__(
        self,
...
class RalfRetrievalAugmentedCGLGANGeneratorModel(RalfCGLGANPreTrainedModel):
    def __init__(
        self,
        config: RalfCGLGANConfig,
        tokenizer: Optional[RalfTokenizer] = None,
        ...
        **kwargs: Any,
        ...
        features = _resolve_features(tokenizer, label_names, features)
        self.model = RetrievalAugmentedCGLGenerator(
            features=features,
            backbone=config.backbone,
            in_channels=config.in_channels,
            out_channels=config.out_channels,
...
class RalfCGLGANDiscriminatorModel(RalfCGLGANPreTrainedModel):
    def __init__(
        self,
        config: RalfCGLGANConfig,
        tokenizer: Optional[RalfTokenizer] = None,
