...
from ralf.transformers.internal.helpers.sampling import sample
...
class BaseRetrievalAugmentedAutoreg(BaseModel):
    ...
    def preprocess(self, inputs: dict) -> tuple[dict, dict]:
        ...
        assert inputs["retrieved"]["image"].size(2) == 4, (
...
class BaseAuxilaryTaskCrossAttnRetrievalAugmentedAutoreg(BaseRetrievalAugmentedAutoreg):
    def __init__(
        ...
        **kwargs,
        ...
        assert auxilary_task in COND_TYPES, (
        ...
        if shared_embedding:
            logger.info("Use shared embedding btw Transfomer Encoder and Decoder")
