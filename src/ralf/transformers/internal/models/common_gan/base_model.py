...
from ralf.transformers.internal.helpers.layout_tokenizer import GEO_KEYS
from ralf.transformers.internal.helpers.task import COND_TYPES
from ralf.transformers.internal.models.common.base_model import BaseModel
...
class BaseGANGenerator(BaseModel):
    ...
    def preprocess(self, inputs: dict) -> tuple[dict, dict]:
        ...
        random_layout: Tensor = random_init_layout(
            ...
            num_classes=self.d_label,
        ).type_as(batch["image"])  # [bs, 10, 2, NUM_ELEM]
